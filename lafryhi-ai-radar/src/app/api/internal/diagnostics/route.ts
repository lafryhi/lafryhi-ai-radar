...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.info(JSON.stringify({
      ...
      vertexStatus: result.vertexAi.connectivity.status,
      vertexModel: result.vertexAi.connectivity.actualModel,
      vertexRegion: result.vertexAi.connectivity.region,
      vertexLatencyMs: result.vertexAi.connectivity.latencyMs,
      vertexFallbackUsed: result.vertexAi.connectivity.fallbackUsed,
      vertexAttempts: result.vertexAi.connectivity.attempts,
      productionContractValid: result.vertexAi.productionContract.structuredJsonValid,
